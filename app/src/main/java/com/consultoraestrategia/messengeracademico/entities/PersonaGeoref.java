...
public class PersonaGeoref extends BaseModel {

    @PrimaryKey (autoincrement=true)
    @Column
    private int personaGeorefId;
    @Column
    ...
    public PersonaGeoref( ) {
    }

    public int getPersonaGeorefId() {
        return personaGeorefId;
    }

    public void setPersonaGeorefId(int personaGeorefId) {
        this.personaGeorefId = personaGeorefId;
    }
