package com.consultoraestrategia.messengeracademico.fullScreen;
...
public class FullscreenActivity extends AppCompatActivity {
    ...
    /**
     * Schedules a call to hide() in [delay] milliseconds,ch canceling any
