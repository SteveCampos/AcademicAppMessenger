...
public class LoadProfileInteractorImpl implements LoadProfileInteractor {
    ...
    public LoadProfileInteractorImpl() {
        this.repository = new LoadProfileRepositoryImpl();
    }

    @Override
    public void executeUpdateProfile(Uri mUri, String mName, String mPhoneNumber) {
        repository.updateProfile(mUri,mName,mPhoneNumber);
    }
